...
public class GoodsAdminController extends BaseController {
	...
	public void index(){
		Page<Goods> pageData=service.paginateAdminData(getPageNumber(),PageSize.PAGESIZE_ADMIN_LIST,getKeywords(),getBoolean("onSale"),getBoolean("isHot"),getBoolean("isRecommend"),getBoolean("isDelete",false),getInt("bcategoryId"),getInt("fcategoryId"));
		keepPara();
	...
	public void edit(){
		...
		set("imghost", PropKit.get("domain"));
		set("goods", goods);
		processFormDatas();
		render("form.html");
	}

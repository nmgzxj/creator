...
public class JboltFileService extends BaseService<JboltFile> {
	...
	protected JboltFile dao() {
		return JboltFile.dao;
	}
	

	public Page<JboltFile> paginateAdminData(Integer pageNumber, int pageSize) {
	 ...
	 * @return
	 */
	public Ret saveVedioFile(Integer userId,UploadFile file, String uploadPath) {

...
public class WechatMpinfoAdminController extends BaseController {
	...
	public void index(){
		keepPara();
		setAttr("pageData", service.paginateAdminList(getPageNumber(),PageSize.PAGESIZE_ADMIN_LIST,getKeywords(),getEnable(),getType(),getInt("subjectType"),getBoolean("isAuthenticated")));
		render("index.html");
	}
